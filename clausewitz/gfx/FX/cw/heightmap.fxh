# TileToHeightMapScaleAndOffset[5] used to be TileToHeightMapScaleAndOffset[ PDX_MAX_HEIGHTMAP_COMPRESS_LEVELS ]
# As this was only referenced here and is fairly unchanging, just remove the global define 
